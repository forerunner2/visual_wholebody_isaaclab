...
def some_public_function(x: int):
    print("[visual_wholebody_isaaclab] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[visual_wholebody_isaaclab] startup")
    ...
    def on_shutdown(self):
        print("[visual_wholebody_isaaclab] shutdown")