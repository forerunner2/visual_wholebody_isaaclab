...
All the environments are registered in the `visual_wholebody_isaaclab` extension. They start
...
def main():
    """Print all environments registered in `visual_wholebody_isaaclab` extension."""
